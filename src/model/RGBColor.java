...
public class RGBColor implements Comparable<RGBColor>, Iterable<Double>
{
    ...
    public RGBColor rbgToYCbCr() {
		double Y = 0.299 * myRed + 0.587 * myGreen + 0.114 * myBlue;
		double Cb = 0.492 * (myBlue - Y);
		double Cr = 0.877 * (myRed - Y);
	...
	public RGBColor yCbCrtoRGB() {
		double r = myRed + 1.140 * myBlue;
		double g = myRed - 0.395 * myGreen - 0.581 * myBlue;
		double b = myRed + 2.032 * myGreen;
