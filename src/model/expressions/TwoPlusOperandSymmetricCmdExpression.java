...
public abstract class TwoPlusOperandSymmetricCmdExpression extends ParensExpression {

	protected final static int DEFAULT_NUM_OPERANDS = 2;
	
	public TwoPlusOperandSymmetricCmdExpression(ArrayList<Expression> operands, String ... cmd) {
		super(operands, cmd);
	}
